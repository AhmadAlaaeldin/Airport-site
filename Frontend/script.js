...
window.onload = function() {
    ...
    var alaskaFlight = new Flight('Alaska', 'AK333', 'B737', 'KSEA', 'May 5, 2016 18:00:00', 'May 5, 2016 19:20:00', 'C7');
  
    var unitedFlight = new Flight('United', 'U2001', 'A320', 'KORD', 'May 5, 2016 19:15:00', 'May 5, 2016 22:10:00', 'N17');
  
    var deltaFlight = new Flight('Delta', 'DAL', 'MD90', 'KORD', 'May 5, 2016 19:15:00', 'May 5, 2016 22:10:00', 'N17');
  
     var evaFlight = new Flight('Eva', 'AK313', 'B737', 'KNYC', 'May 2, 2016 18:00:00', 'May 2, 2016 19:20:00', 'K7');
    
     var cebuFlight = new Flight('Cebu', 'AR333', 'B737', 'KLA', 'May 5, 2016 18:00:00', 'May 5, 2016 19:20:00', 'C8');
   ...
   html += "<tr><td>"+cebuFlight["airline"]+"</td><td>"+cebuFlight["number"]+"</td><td>"+cebuFlight["origin"]+"</td><td>"+cebuFlight["destination"]+"</td><td>"+cebuFlight["dep_time"]+"</td><td>"+cebuFlight["arrival_time"]+"</td><td>"+cebuFlight["arrival_gate"]+"</td></tr>";
